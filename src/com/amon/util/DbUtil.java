...
public class DbUtil {
	...
	public static Connection buildUpDb(){
		 ...
		 try {
			    ...
			    //创建表
			    stat.executeUpdate("CREATE TABLE if not exists `t_book` ( `id` int(11) NOT NULL AUTO_INCREMENT,`bookName` varchar(255) DEFAULT NULL,`author` varchar(255) DEFAULT NULL,  `sex` varchar(255) DEFAULT NULL,  `price` decimal(10,0) DEFAULT NULL,  `keeproom` varchar(255) DEFAULT NULL,  `count` int(11) DEFAULT NULL,  `stocks` varchar(255) DEFAULT NULL,  `bookTypeId` int(11) DEFAULT NULL,  `bookDesc` varchar(255) DEFAULT NULL,  PRIMARY KEY (`id`),  KEY `bookTypeid` (`bookTypeId`)) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8;"); 
