...
public class BookManagerIntFrm extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BookManagerIntFrm frame = new BookManagerIntFrm();
	...
	private void addBookActionPerformed(ActionEvent e) {
		...
		try {
			...
			String sex;
			int bookTypeid;
			int priceInt=Integer.valueOf(bookPriceTxt2.getText());	
			...
			Book book=new Book(bookid,bookName,authorName,sex,priceInt,bookTypeid,bookdesc);
			System.out.println("bookmanagerintfrm------"+book.getId());
